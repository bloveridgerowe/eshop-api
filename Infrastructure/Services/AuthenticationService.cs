...
public sealed class AuthenticationService : IAuthenticationService
{
    ...
    public async Task<TokenSet> CreateTokensForUser(String email, String password)
    {
        ...
        ApplicationUserSession newUserSession = new ApplicationUserSession
        {
            ...
            Device = _httpContextAccessor.HttpContext?.Request.Headers.UserAgent.ToString(),
    ...
    private void LogRefreshAttempt(String hashedRefreshToken, Boolean successful, String message)
    {
        ...
        _logger.LogInformation("Refresh attempt from device with UserAgent: '{userAgent}', HashedRefreshToken: '{hashedRefreshToken}', Successful: '{successful}', Message: '{message}'",
            userAgent, hashedRefreshToken, successful, message);
    }
